...
<a href="<?php echo base_url().'products/buyProduct/'.$product['id']; ?>"><img src="<?php echo base_url(); ?>assets/images/buy-button/53256904-buy-now-button.jpg" style="width: 70px;"></a>
</div>
